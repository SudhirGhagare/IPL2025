  ...
  matches.forEach((match) => {
    ...
    matchDiv.innerHTML = `
            <div class="match-left">
                <div class="match-number-box">MATCH ${
                  match["Match Number"]
                }</div>
                <div class="timeline">
                    <div class="dot"></div>
            ...
            <div class="match-right">
                ...
                <div class="teams">
                    <div class="team">
                        <img class="team-logo" src="../../assets/icon/teams-icon/team_${
                          teamMap[match["Home Team"]]
                        }.avif" alt="${match["Home Team"]}">
                        <div class="team-name">${match["Home Team"]}</div>
                    </div>
                    <div class="vs">vs</div>
                    <div class="team">
                        <img class="team-logo" src="../../assets/icon/teams-icon/team_${
                          teamMap[match["Away Team"]]
                        }.avif" alt="${match["Away Team"]}">
...
function toggleTab(clickedTab) {
  ...
  document.getElementById("match-container").style.display =
    tabText === "Group Stage" ? "block" : "none";
  document.getElementById("playoff-frame").style.display =
    tabText === "Play-Off" || tabText === "Points Table" ? "block" : "none";

  if (tabText === "Play-Off") {
    document.getElementById("playoff-frame").src =
      "https://react-deployment-pied.vercel.app/";
